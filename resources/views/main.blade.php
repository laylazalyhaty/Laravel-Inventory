...
<head>
    ...
    <title>@yield('title') - Project Kasir</title>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">MyKasir</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('karyawan') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Karyawan</a>
                    </li>
                    <li>
                        <a href="{{ url('pembelian') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Transaksi Pembelian</a>
                    </li>
                    <li>
                        <a href="{{ url('penjualan') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Transaksi Penjualan</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
